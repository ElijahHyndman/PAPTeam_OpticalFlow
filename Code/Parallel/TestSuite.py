...
# === Test Run Function
def TestRun(Progression='Default',ImagesPerCollection=3,pyramidLevels=3,threadProgression=(1,2,3,4),Repetitions=1):
        ...
        for COLLECTION in CollectionProgressions[Progression]:
            ...
            for numCores in threadProgression:
                ...
                for IMAGEPAIR in ImagePairs[:ImagesPerCollection]:
                   ...
                   CalculateOpticalFlow(IMAGEPAIR,pyramidLevels,numCores)
                   imageIndex+=1
    # == End Test Run
...
TestRun(Progression='Full',ImagesPerCollection=10,pyramidLevels=6,threadProgression=(1,2,4,8,16,24),Repetitions=1)
