...
//
//-------------------------------------------------------
void myfunc(){cout<<"heoo";}
void OpticalFlow::Coarse2FineFlow(map<string,string>* TIMING_PROFILE, DImage &vx, DImage &vy, DImage &warpI2,const DImage &Im1, const DImage &Im2, int pyramidLevels)
{
